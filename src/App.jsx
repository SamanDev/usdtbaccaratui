                                ...
                                <span id={"slot" + pNumber} className={gameData.status == "Done" && gameData.gameOn && gameData.win == player.x ? "players result-win" : gameData.status == "Done" && gameData.gameOn ? "players" : "players"} key={pNumber} style={getTotalBets(pNumber) == "0K" && gameData.gameOn ? { opacity: 0.9 } : {}}>
                                            ...
                                            {allBetold.map(function (player, pNumber) {
                                                return (
                                                    <Popup
                                                        ...
                                                        on="hover"
                                                        trigger={
                                                            <button className="betButtons animate__animated animate__zoomInDown" style={{ animationDelay: (pNumber + 1) * 50 + "ms", left: pNumber * -5, top: pNumber * 10 }} id={"chip" + _renge.findIndex((bet) => bet == player.amount / 1000)}>
                                    ...
                                    <div id="bets-container-left">
                                        <span className={gameData.seats[pNumber]?.sidep > 0 ? "winner" : ""}>
                                            ...
                                            {sidePPPlayer && (
                                                <button className="betButtons placebet noclick animate__animated animate__rotateIn" id={"chip" + _renge.findIndex((bet) => bet === sidePPPlayer / 1000)}>
                                    ...
                                    <div id="bets-container-right">
                                        <span className={gameData.seats[pNumber]?.side3 > 0 ? "winner" : ""}>
                                            ...
                                            {side213layer && (
                                                <button className="betButtons placebet noclick animate__animated animate__rotateIn" id={"chip" + _renge.findIndex((bet) => bet === side213layer / 1000)}>
